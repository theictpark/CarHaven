        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-sm-6">
                    <div class="about-img">
                        <img class="about-img1" src="{{ asset('user') }}/assets/img/about-1.png" alt="img">
                        <img class="about-img2" src="{{ asset('user') }}/assets/img/about-2.png" alt="img">
                        <figure class="round-text"><img src="{{ asset('user') }}/assets/img/experience-text-round.png" alt="img"></figure>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    ...
                    <ul class="about-info">
                        <li>
                            <img class="owner-thumb" src="{{ asset('user') }}/assets/img/comment-1.png" alt="thumb">
                            <div class="owner">
                                <h4>Azmol - CEO</h4>
                                <img class="signature" src="{{ asset('user') }}/assets/img/signature.png" alt="signature">
                            </div>
                        </li>
                        <li>
                            <h2><span>Call For Taxi</span><a href="tel:+8801911418419">01911418419</a></h2>
                        </li>
                    </ul>
                </div>
            </div>
